...
const ResponsiveSignUpForm: React.FC<SignUpFormProps> = ({ 
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-h-[95vh] overflow-y-auto">
      ...
      {/* Account Already Exists State */}
      {success === 'ACCOUNT_EXISTS' && (
        <div className="mb-6 sm:mb-8 p-4 sm:p-6 bg-orange-50 border border-orange-200 rounded-xl">
          <div className="flex items-start">
            <AlertTriangle className="h-5 w-5 sm:h-6 sm:w-6 text-orange-500 mt-1 mr-3 sm:mr-4 flex-shrink-0" />
            <div className="flex-1 min-w-0">
              <h4 className="text-orange-800 font-semibold text-base sm:text-lg mb-2">🚨 Account Already Exists</h4>
              <p className="text-orange-700 mb-4 text-sm sm:text-base break-words">
                An account with email <strong>{formData.email}</strong> already exists in our system.
              </p>
              
              <div className="bg-white p-3 sm:p-4 rounded-lg border border-orange-300 mb-4">
                <h5 className="text-orange-800 font-medium mb-2 flex items-center text-sm sm:text-base">
                  <LogIn className="h-3 w-3 sm:h-4 sm:w-4 mr-2 flex-shrink-0" />
                  What you can do:
                </h5>
                <ul className="text-orange-700 text-xs sm:text-sm space-y-1">
                  <li>• Sign in with your existing account</li>
                  <li>• Use "Forgot Password" if you don't remember your password</li>
                  <li>• Try a different email address if you want a new account</li>
                </ul>
              </div>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-orange-600 hover:bg-orange-700 text-white py-3 rounded-lg font-semibold transition-colors flex items-center justify-center space-x-2 text-sm sm:text-base shadow-lg hover:shadow-xl transform hover:scale-[1.02]"
                >
                ...
                <button
                  ...
                  className="w-full bg-white hover:bg-gray-50 text-orange-700 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center space-x-2 text-sm sm:text-base border-2 border-orange-200 hover:border-orange-300"
                >
      ...
      {success && success !== 'ACCOUNT_EXISTS' && success !== 'ACCOUNT_CREATED' && (
        <div className="text-center p-6 sm:p-8">
          {/* Success Icon */}
          <div className="mx-auto mb-6">
      ...
      {/* Switch to Sign In */}
      {!success && success !== 'ACCOUNT_EXISTS' && (
        <>
